...
import { Rating } from 'api/models/share-models';
...
export class RatingComponent implements ControlValueAccessor {
  ...
  @Input()
  set setter(rater: Rating) {
    this._rater = rater;
    const ratio = rater.max / this._max;
    this.value = rater.average / ratio;
  }
